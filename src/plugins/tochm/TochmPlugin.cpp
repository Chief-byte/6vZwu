...
TochmPlugin::TochmPlugin()
    : mainWindow_(nullptr),
      pluginWindow_(nullptr)
{
}

void TochmPlugin::initialize(MainWindow *mainWindow)
{
...
void TochmPlugin::slotPlugin()
{
    // Create GUI only when this plugin is used for the first time
    if (!pluginWindow_)
    {
        pluginWindow_ = new TochmWindow(mainWindow_);
    }
