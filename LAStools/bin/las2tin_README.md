...
-histo_edge_length [n]              : output histogram about edge_length with bin size [n]
-histo_max_edge_length [n]          : output histogram about max_edge_length with bin size [n]
-histo_min_edge_length [n]          : output histogram about area with bin size [n]
-histo_min_max_edge_length_diff [n] : output histogram about min_max_edge_length_diff with bin size [n]
-histo_only                         : output only histogram
