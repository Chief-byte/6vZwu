...
-band [n]                           : use band [n] for single band operations
-band_into_blue [n]                 : copies band [n] into the blue (B) channel
-band_into_green [n]                : copies band [n] into the green (G) channel
-band_into_intensity [n]            : copies band [n] into the intensity channel
-band_into_nir [n]                  : copies band [n] into the NIR channel
-band_into_red [n]                  : copies band [n] into the red (R) channel
-blue                               : copies selected band (-band) into the blue (B) channels
-classify [n]                       : classify points as [n] instead of clip away
-classify_as [n]                    : classifies points falling into a black pixel as [n]
-classify_black                     : points falling into a black pixels (default)
...
-grey                               : copies selected band (-band) into all three RGB channels
...
-image [n]                          : specifies *single* image file [n] to be used for coloring (all) input file(s)
-imagedir [dir]                     : specifies directory [dir] where correspondingly named image files are located
-imgpng                             : use PNG as image file format
-imgtif                             : use TIFF as image file format
-intensity                          : copies selected band (-band) into the intensity field
-nir                                : copies selected band (-band) into the NIR channel
...
-pairs [n]                          : locally correct image alignment via IDW vectors in file [n]
-red                                : copies selected band (-band) into the red (R) channels
