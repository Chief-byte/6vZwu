...
-height_in_z                  : interpret z value as normalized height
...
-step [n]                     : set grid cell size to [n] for planar/non-planar analysis (default=2)
-sub [n]                      : use [n] substeps for analysis (default=2..8, depending on value of requested '-step')
