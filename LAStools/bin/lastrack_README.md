...
Resolution is cm, so you will have values between (-327.68 - 327.67 m).
Height_precise ist stored as 32 Bit integer/1000.
Resolution is mm, so you will have values between (âˆ’2147483.648 - 2147483.647 m).
...
-classify_above [z] [c]             : classify points with vertical distance of [z] or higher from (offset) trajectory as [c]
-classify_below [z] [c]             : classify points with vertical distance of [z] or lower from (offset) trajectory as [c]
-classify_between [z1] [z2] [c]     : classify points with vertical distance between [z1] and [z2] from (offset) trajectory as [c]
-classify_height_above [n] [o]      : classify all z values above [n] as [o]
-classify_height_below [n] [o]      : classify all z values below [n] as [o]
-classify_height_between [m] [n] [o]: classify all z values between [m] and [n] as [o]
-classify_xy_range_and_height_between [m] [n] [z1] [z2] [c]: classify points with xy-distance between [m] and [n] from trajectory and vertical distance between [n1] and [z2] from (offset) trajectory as [c]
-classify_xy_range_between [m] [n] [c]: classify points with xy-distance between [m] and [n] from trajectory as [c]
-classify_xyz_range_between [m] [n] [c]: classify points with xyz-distance between [m] and [n] from trajectory as [c]
-cores [n]                          : process multiple inputs on [n] cores in parallel
-drop_above [n]                     : drop points with vertical distance of [n] or higher from (offset) trajectory
-drop_below [n]                     : drop points with vertical distance of [n] or lower from (offset) trajectory
-drop_between [m] [n]               : drop points with vertical distance between [m] and [n] from (offset) trajectory
-drop_height_above [n]              : drop all z values above [n]
-drop_height_below [n]              : drop all z values below [n]
-drop_height_between [m] [n]        : drop all z values between [m] and [n]
...
-offset [n]                         : constant vertical offset [n] from trajectory to ground (for mobile scans by truck or boat)
...
-track [fnp]                        : use [fnp] as file containing trajectory with GPS time
