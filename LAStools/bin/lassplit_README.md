...
-by_attribute_interval [n]        : split points based on attribute with index in intervals of [n]
-by_classification                : split based on the classification code
-by_gps_time_interval [n]         : split points into intervals of [n] seconds
-by_intensity_interval [n]        : split points based on intensty intervals of [n]
-by_scan_angle_interval [n]       : split points based on scan angle intervals of [n]
-by_user_data_interval [n]        : split points based on user data intervals of [n]
...
-recover_flightlines_interval [n] : split points after recovering flight lines from [n] second GPS time interruptions
