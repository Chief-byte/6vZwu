...
-check_return_numbering     : print histogram about missing or duplicate returns
-classify_as [n]            : classify points with missing returns as [n]
-classify_duplicate_as [n]  : classify points with duplicate returns as [n]
-classify_duplicates_as [n] : classify points with duplicate returns as [n]
-classify_missing_as [n]    : classify points with missing returns as [n]
...
-histo [a] [s] [m] [n]      : compute histogram about [a](return_distance/angle_bigger_error/scan_angle_detail) with size [s], optional limit to range between [m] and [n]
-ilay [n]                   : apply [n] or all LASlayers found in corresponding *.lay file on read
-ilaydir [n]                : look for corresponding *.lay file in directory [n]
-len_report [n]             : limit vector length by a cutoff of [n]
...
-repair_number_of_returns   : repair invalid number of return values
-skip_incomplete            : skip incomplete returns
