...
-adjust_z                 : apply resulting average error as vertial adjustment to all files.
-cp [fnt]                 : load control points with parse string xyz from file [fnt] and visualize each as red sphere with radius 1 meter
-cp_ignore_diff [n]       : ignore control points with absolute value > [n]
-cp_ignore_diff_above [n] : ignore control points above [n]
-cp_ignore_diff_below [n] : ignore control points below [n]
-cp_out [fnt]             : report result to [fnt] (stdout otherwise)
-cp_parse [xyz]           : use parse string [xyz] to parse control point file
-feet                     : use feet as horizontal unit
...
-skip [n]                 : skip first [n] lines of input
-step [n]                 : set cell square size to [n] meter
